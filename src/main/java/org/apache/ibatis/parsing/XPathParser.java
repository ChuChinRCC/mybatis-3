...
public class XPathParser {
   ...
   * XML实体解析器
   *
   * entityResolver 属性，org.xml.sax.EntityResolver 对象，
   ...
   * 所以，在实际场景下，MyBatis 自定义了 EntityResolver 的实现，
...
//    用 PropertyParser#parse(String string, Properties variables) 方法，基于 variables 替换动态值，
